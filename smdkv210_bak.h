 ...
 */
#define CONFIG_SYS_MALLOC_LEN		(CONFIG_ENV_SIZE + 896*1024)  /*cf*//*(CONFIG_ENV_SIZE + (1 << 20))*/   
/*
...
/* memtest works on */
#define CONFIG_SYS_MEMTEST_START	CONFIG_SYS_SDRAM_BASE       /*0x20000000*/
#define CONFIG_SYS_MEMTEST_END		(CONFIG_SYS_SDRAM_BASE + 0x3ffffff)  /*0x20000000 + 0x3ffffff*/
#define CONFIG_SYS_LOAD_ADDR		(PHYS_SDRAM_1 + 0x1000000)	/* default load address	*//*cf*//*CONFIG_SYS_SDRAM_BASE*/
...
#define PHYS_SDRAM_1_SIZE	0x20000000	/* 0x8000000, 128 MB Bank #1 */
...
#define CONFIG_SYS_NO_FLASH		1
#undef CONFIG_CMD_IMLS
#define CONFIG_IDENT_STRING	" for MINI210S"
...
#define CONFIG_ENV_SIZE			0x4000      /*16K*/ /*cf*/     /*(128 << 10)*/	/* 128KiB, 0x20000 */
...
//#define CONFIG_SYS_INIT_SP_ADDR	            0x3FF00000
